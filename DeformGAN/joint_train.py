...
def train(unused_argv):
    ...
    g_optimizer = optim.Adam(generator.parameters(), lr=FLAGS.generator_lr, betas=(0., 0.9))
    d_optimizer = optim.Adam(discriminator.parameters(), lr=FLAGS.discriminator_lr, betas=(0., 0.9))
    ...
    for epoch in range(FLAGS.num_epochs):
        ...
        for i, batch in enumerate(dataloader):
            ...
            if i % 10 == 0:
                ...
                gan_loss = - 0.1 * discriminator(app_img, app_pose_img, gen_img, pose_img).mean()
